...
#ifndef _WIN32
#define SKF_FUN_DEF(name,args) \
    u32 cc_##name args; \
    extern u32 __attribute__ ((visibility("default"))) name args
#else
...
#define V_F_KEY_LITTLE_ENDIAN	0x00000080
    ...
    #define V_CTL_GEN_CR       0x1001 
    #define V_CTL_VERIFY_SS    0x1002 
    #define V_CTL_PRV_READ     0x1003 
    #define V_CTL_PRV_WRITE    0x1004 
    #define V_CTL_PRV_CAPACITY 0x1005 
    SKF_FUN_INFO(V_Control, (HANDLE hHandle, u32 request, ...));
